...
class SponsorViewController: UIViewController, SideMenuItemContent {
    ...
    func setupHeader() {
        ...
        let hView = header.createHeader(title: "", subtitle:nil, imageURL: nil, image: nil, isProfile: false)
...
extension SponsorViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "Company " + String(indexPath.row) + " name: " + String(indexPath.section + 1)
