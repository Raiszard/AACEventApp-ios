...
class HostViewController: MenuContainerViewController {
    ...
    private func contentControllers() -> [UIViewController] {
        let controllersIdentifiers = ["About", "Planning Team", "Initiatives", "Donate", "StayConnected", "Information", "Norms", "TabBar", "Speakers", "AACare Team", "Attendees", "Cohorts",  "Sponsors", "Conference Evaluation", "FAQ"]
