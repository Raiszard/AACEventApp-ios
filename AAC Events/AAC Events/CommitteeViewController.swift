...
class CommitteeViewController: UIViewController, SideMenuItemContent {
    ...
    let orgNameArray: [String] = ["Zachia Nazarzai","Dawoud Niaz","Edrees Kharzai","Nashwa Osmani","Hamza Yaqoobi","Silgai Mohmand","Yosef Mahmood","Aresh Ramin","Darya Moini","Bahman Hassan","Lida Azim","Robia Qasimyar","Sabrina Zarifi","Sadaf Rohani","Yama Amin","Omed Amin","Husna Ghayaisi","Nadeema Safi","Sahar Yaqubi"]
