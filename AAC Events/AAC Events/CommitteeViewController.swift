...
class CommitteeViewController: UIViewController, SideMenuItemContent {
    ...
    let orgNameArray: [String] = ["Zachia Nazarzai", "Sara Noorzay", "Atiq Ahmadullah", "Gina Karimi", "Arzo Kaderi", "Mukhtar Mayan", "Nazieh Fazli", "Madina Salemi Nooristani", "Aresh Ramin", "Sabrina Noorzay", "Lida Azim", "Omar Aziz", "Sophie Hossein"]
