...
class NavigationMenuViewController: MenuViewController, MFMessageComposeViewControllerDelegate {
    ...
    let aacMenus = ["About AACO", "AACO Team", "Programs", "Regions", "Support AACO", "Stay Connected", "Contact Us"]
    let menuItems =  ["Norms", "Agenda", "Speakers/Performers", "CARE Team", "Conference Ambassadors", "Cohorts",  "Sponsors", "Conference Evaluation", "FAQs"]
